...
let cloudinary = require('../multer/cloudinary')
...
let getevent = async (req, res) => {
    ...
    try {
        ...
        let events = await eventModel.find({ authid: userId });
...
let updateevent = async (req, res) => {
    ...
    try {
        ...
        let existingEvent = await eventModel.findOne({ _id: eventId, authid: userId });
        ...
        let updatedEvent = await eventModel.findByIdAndUpdate(eventId, updates, {
            new: true,
            runValidators: true
        });
...
let deleteevent = async (req, res) => {
    ...
    try {
        ...
        let deletedEvent = await eventModel.findOneAndDelete({ _id: eventId, authid: userId });
